...
impl Default for AdvancedSettings {
    fn default() -> Self {
        Self {
            ...
            log_filter: "firezone_windows_client=debug,webrtc_mdns=error,firezone_tunnel=trace,connlib_shared=debug,connlib_client_shared=debug,warn".to_string(),
        }
    }
}
...
impl Default for AdvancedSettings {
    fn default() -> Self {
        Self {
            ...
            log_filter: "firezone_windows_client=info,webrtc_mdns=error,firezone_tunnel=trace,connlib_shared=info,connlib_client_shared=info,webrtc=error,warn".to_string(),
        }
    }
}
