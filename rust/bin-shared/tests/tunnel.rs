use firezone_bin_shared::{platform::{tcp_socket_factory, udp_socket_factory}, TunDeviceManager};
...
async fn no_packet_loops_udp() {
    ...
    // Make a socket.
    let mut socket = udp_socket_factory(&SocketAddr::V4(SocketAddrV4::new(
