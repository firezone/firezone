...
listen<Settings>('settings_changed', (e) => {
  ...
  if (settings.auth_url_is_managed) {
    authBaseUrlInput.dataset['tip'] = "This settings is managed by your organization."
  }

  if (settings.api_url_is_managed) {
    apiUrlInput.dataset['tip'] = "This settings is managed by your organization."
  }

  if (settings.log_filter_is_managed) {
    logFilterInput.dataset['tip'] = "This settings is managed by your organization."
  }
})
