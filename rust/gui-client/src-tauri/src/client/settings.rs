...
impl Default for AdvancedSettings {
    fn default() -> Self {
        Self {
            ...
            log_filter: "firezone_gui_client=debug,firezone_tunnel=trace,phoenix_channel=debug,connlib_shared=debug,connlib_client_shared=debug,boringtun=debug,snownet=debug,str0m=info,warn".to_string(),
        }
    }
}
...
impl Default for AdvancedSettings {
    fn default() -> Self {
        Self {
            ...
            log_filter: "firezone_gui_client=info,firezone_tunnel=trace,phoenix_channel=info,connlib_shared=info,connlib_client_shared=info,boringtun=debug,snownet=debug,str0m=info,warn".to_string(),
        }
    }
}
