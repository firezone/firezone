 ...
 */
export type X509FieldProblem = { Invalid: X509ValidationError } | { Unusable: X509UnusableCause }
/**
 ...
 */
export type X509UnusableCause = "UnsupportedKeyAlgorithm" | { KeyRefused: { error: string } } | "KeyMissing"
/**
