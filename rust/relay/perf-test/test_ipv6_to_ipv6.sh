...
# IPv6 to IPv6 relay throughput test
...
echo "=== IPv6 to IPv6 Relay Throughput Test ==="
echo "Relay IP: $RELAY_IP"
echo "Payload: $PAYLOAD_SIZE bytes"
echo "Duration: $DURATION seconds"
echo ""

# Populate eBPF maps for IPv6 to IPv6
echo "Populating eBPF maps for IPv6 to IPv6..."
sudo "$SCRIPT_DIR/map_populate.sh" ipv6
