...
pub fn login_url(
    ...
    // FIXME: read FIREZONE_HOSTNAME from env (eg. for gateways) and resolve system hostname for rest
    let hostname: String = thread_rng()
...
fn get_websocket_path(
...

    {
        ...
        query_pairs.append_pair("hostname", hostname);
    }
