...
const UDP_RECV_BATCH_LIMIT: usize = {
...
/// [`MAX_UDP_OUTBOUND_QUEUE_MEMORY`] for the resulting bound. On mobile platforms we are even more
/// memory-constrained and keep it smaller still.
