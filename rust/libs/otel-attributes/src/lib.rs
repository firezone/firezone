...
//! dimensions of a metric, so every distinct value creates a new time series.
//! Constructors here therefore collapse unbounded inputs (error messages,
