            ...
            Transition::EditResource(edit) => {
                ...
                let gateway_action = match &edit {
                    ...
                    client::ResourceEdit::Cidr(edit) => match &edit.value {
                        ...
                        client::CidrResourceValue::Name(_) => GatewayAction::Update,
                    ...
                    client::ResourceEdit::StaticDevicePool(_) => GatewayAction::None,
                    client::ResourceEdit::DynamicDevicePool(_) => GatewayAction::None,
