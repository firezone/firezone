...
use super::values::{
    ...
    arb_different_dns_resource_address, arb_different_dynamic_device_pool_address,
    arb_different_filters, arb_different_ip_stack_kind, arb_domain_name_string, arb_ip_stack_kind,
    arb_system_dns_servers, arb_upstream_doh_servers,
};
        ...
        Resource::DynamicDevicePool(resource) => {
            ...
            let value = match field {
                ...
                DynamicDevicePoolResourceValue::Address(_) => {
                    DynamicDevicePoolResourceValue::Address(
                        arb_different_dynamic_device_pool_address(g, &resource.address),
                    )
                }
