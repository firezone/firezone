defmodule Web.SettingLive.CustomizationTest do
  ...
  describe "logo" do
    ...
    test "reset to default", %{view: view, html: html} do
      ...
      assert Domain.Config.fetch_config!(:logo) == nil
    end
    ...
    test "change to url", %{view: view, html: html} do
      ...
      assert %{url: "new"} = Domain.Config.fetch_config!(:logo)
    end
    ...
    test "change to upload", %{view: view, html: html} do
      ...
      assert %{data: ^data, type: "image/jpeg"} = Domain.Config.fetch_config!(:logo)
    end
  end
end
