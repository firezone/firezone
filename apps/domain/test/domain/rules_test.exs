defmodule Domain.RulesTest do
  use Domain.DataCase, async: true
  import Domain.Rules
  alias Domain.{UsersFixtures, SubjectFixtures, RulesFixtures}
  alias Domain.Rules

  setup do
    Domain.Config.put_env_override(:wireguard_ipv4_network, %Postgrex.INET{
      address: {100, 64, 0, 0},
      netmask: 10
    })

    Domain.Config.put_env_override(:wireguard_ipv6_network, %Postgrex.INET{
