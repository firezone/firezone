    ...
    buildTypes {
        ...
        getByName("debug") {
            ...
            buildConfigField(
                "String",
                "LOG_FILTER",
                "\"connlib_client_android=debug,firezone_tunnel=debug,phoenix_channel=debug,connlib_shared=debug,boringtun=debug,snownet=debug,str0m=info" +
        ...
        getByName("release") {
            ...
            buildConfigField(
                "String",
                "LOG_FILTER",
                "\"connlib_client_android=info,firezone_tunnel=debug,phoenix_channel=info,connlib_shared=info,boringtun=debug,snownet=debug,str0m=info," +
                    "connlib_client_shared=info,warn\"",
            )
