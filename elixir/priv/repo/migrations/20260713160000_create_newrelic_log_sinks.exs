defmodule Portal.Repo.Migrations.CreateNewRelicLogSinks do
  use Ecto.Migration
  ...
  def up do
    ...
    create table(:newrelic_log_sinks, primary_key: false) do
  ...
  def down do
    drop(table(:newrelic_log_sinks))
    drop(constraint(:log_sinks, :type_must_be_valid))
    create(constraint(:log_sinks, :type_must_be_valid, check: "type IN ('splunk', 'datadog')"))
  end
end
