defmodule Portal.Repo.Migrations.CreateS3LogSinks do
  use Ecto.Migration
  ...
  def up do
    ...
    create table(:s3_log_sinks, primary_key: false) do
      ...
      add(:role_arn, :string, null: false)
    ...
    create(unique_index(:s3_log_sinks, [:account_id, :name]))
  end

  def down do
    drop(table(:s3_log_sinks))
    drop(constraint(:log_sinks, :type_must_be_valid))
