defmodule Portal.Repo.Seeds do
  ...
  # Synthetic CA used by local seeds for end-to-end device trust testing. This
  # is the issuer for the leaf cert fixture documented in elixir/README.md.
  #
  # Generated with:
  ...
  @firezone_device_trust_seed_ca_pem """
  -----BEGIN CERTIFICATE-----
  
  MeLBHe11siZoY2YIlTRpP+/Uz08uChQt
  -----END CERTIFICATE-----
  """
  ...
  def seed do
    ...
    |> cast(
      %{
        name: "Firezone Device Trust Test CA",
        certs: [@firezone_device_trust_seed_ca_pem]
      },
      [:name, :certs]
    )
