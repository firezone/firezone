defmodule Portal.Entra.SchedulerTest do
  ...
  describe "perform/1" do
    test "schedules sync jobs for enabled directories with idp_sync feature" do
      ...
      # Create multiple Entra directories for this account
      dir1 = entra_directory_fixture(account: account, name: "Directory 1")
      dir2 = entra_directory_fixture(account: account, name: "Directory 2")
    ...
    test "does not schedule jobs for disabled directories" do
      ...
      enabled_dir = entra_directory_fixture(account: account, name: "Enabled Directory")
    ...
    test "does not schedule jobs for directories with disabled accounts" do
      ...
      enabled_dir = entra_directory_fixture(account: enabled_account, name: "Enabled Directory")
    ...
    test "does not schedule jobs for accounts without idp_sync feature" do
      ...
      _dir = entra_directory_fixture(account: account_without_feature, name: "Directory")

      # Account with idp_sync feature
      account_with_feature = account_fixture(features: %{idp_sync: true})

      enabled_dir =
        entra_directory_fixture(account: account_with_feature, name: "Enabled Directory")
    ...
    test "schedules multiple jobs for multiple accounts" do
      ...
      dir1 = entra_directory_fixture(account: account1, name: "Account 1 Directory")
      dir2 = entra_directory_fixture(account: account2, name: "Account 2 Directory")
