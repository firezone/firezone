defmodule Portal.ConfigTest do
  ...
  defmodule Test do
    ...
    defconfig(:url, :string,
      changeset: fn changeset, key ->
        changeset
        |> Portal.Changeset.validate_uri(key)
  ...
  describe "env_var_to_config!/1" do
    ...
    test "raises an error when value is invalid" do
      ...
      Errors:
       ...
       - `\"a.b.c.d\"`: a.b.c.d is invalid: einval\
      """
    ...
    test "casts module name enums" do
      ...
      assert env_var_to_config!(Test, :enum, %{"ENUM" => "value2"}) == Portal.ConfigTest.Test
