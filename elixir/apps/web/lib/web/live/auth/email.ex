defmodule Web.Auth.Email do
        ...
        <div class="w-full col-span-6 mx-auto bg-white rounded-lg shadow dark:bg-gray-800 md:mt-0 sm:max-w-lg xl:p-0">
          <div class="p-6 space-y-4 lg:space-y-6 sm:p-8">
            ...
            <div :if={not is_nil(@client_platform)}>
              ...
              <form
                action={~p"/#{@account_id_or_slug}/sign_in/providers/#{@provider_id}/verify_sign_in_token"}
                method="get"
                class="my-4 flex"
              >
  ...
  defp resend(assigns) do
    ...
    <.form
      ...
      as={:email}
      class="inline"
      action={~p"/#{@account_id_or_slug}/sign_in/providers/#{@provider_id}/request_magic_link?resend=true"}
      method="post"
    >
