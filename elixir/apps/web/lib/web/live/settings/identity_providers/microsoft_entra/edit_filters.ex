defmodule Web.Settings.IdentityProviders.MicrosoftEntra.EditFilters do
  use Web, :live_view
  ...
  def render(assigns) do
    ...
    <.breadcrumbs account={@account}>
      ...
      <.breadcrumb path={
        ~p"/#{@account}/settings/identity_providers/microsoft_entra/#{@provider}/edit"
      }>
        Edit
      </.breadcrumb>
    </.breadcrumbs>
    <.section>
      <:title>
        Edit Identity Provider {@provider.name}
      </:title>
      <:content></:content>
    </.section>
    """
