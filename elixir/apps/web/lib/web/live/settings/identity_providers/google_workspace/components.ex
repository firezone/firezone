  ...
  def provider_form(assigns) do
    ...
    <div class="max-w-2xl px-4 py-8 mx-auto lg:py-16">
      <.form for={@form} phx-change={:change} phx-submit={:submit}>
        <div class="mb-4">
          <h2 class="mb-4 text-2xl tracking-tight font-bold text-neutral-900">
    ...
    https://www.googleapis.com/auth/admin.directory.user.readonly</.code_block>
          <p class="mb-4">
        ...
        <div class="mb-4">
          ...
          <p class="mb-4">
            Select <strong>OAuth client ID</strong> and then select <strong>Web application</strong>.
          </p>
          <p class="mb-4">
