defmodule Web.Sites.NewToken do
  ...
  def render(assigns) do
    ...
    <.section>
      ...
      <:help>
        Gateways require outbound access to <code class="text-sm bg-neutral-600 text-white px-1 py-0.5 rounded">api.firezone.dev:433</code> only. <strong>No inbound firewall rules</strong> are required or recommended.
      </:help>
      <:help>
        <.link href="http://www.firezone.dev/kb/deploy/gateways?utm_source=product" class="text-accent-500 hover:underline">Read the gateway deployment guide for more detailed instructions</.link>.
      </:help>
      <:content>
