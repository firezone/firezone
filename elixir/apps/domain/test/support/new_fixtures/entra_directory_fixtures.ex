defmodule Domain.EntraDirectoryFixtures do
  @moduledoc """
  ...
  Domain.Entra.Directory struct. For the generic Domain.Directory struct,
  ...
  def entra_directory_fixture(attrs \\ %{}) do
    ...
    {:ok, entra_directory} =
      ...
      |> Domain.Entra.Directory.changeset()
      |> Domain.Repo.insert()
