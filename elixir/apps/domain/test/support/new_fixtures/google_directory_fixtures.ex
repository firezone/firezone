defmodule Domain.GoogleDirectoryFixtures do
  @moduledoc """
  ...
  Domain.Google.Directory struct. For the generic Domain.Directory struct,
  ...
  def google_directory_fixture(attrs \\ %{}) do
    ...
    {:ok, google_directory} =
      ...
      |> Domain.Google.Directory.changeset()
      |> Domain.Repo.insert()
