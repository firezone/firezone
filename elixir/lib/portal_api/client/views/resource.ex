defmodule PortalAPI.Client.Views.Resource do
  ...
  # The v2 protocol knows a pool as `static_device_pool` with its members inline. It is
  # never sent a pool that picks its devices by a rule, because that has no shape there.
