defmodule PortalAPI.Schemas.ClientSession do
    ...
    OpenApiSpex.schema(%{
      ...
      properties: %{
        ...
        last_seen_version: %Schema{
          type: :string,
          description: "Client version at time of session"
        },
        last_seen_at: %Schema{
          type: :string,
      ...
      example: %{
        ...
        "client_token_id" => "6ecc106b-75c1-48a5-846c-14782180c1ff",
  ...
  defmodule Response do
    ...
    OpenApiSpex.schema(%{
      title: "ClientSessionResponse",
      description: "Response schema for single Client Session",
      type: :object,
      properties: %{
        data: ClientSession.GetSchema
      },
      example: %{
        "data" => %{
          "id" => "a1b2c3d4-e5f6-7890-abcd-ef1234567890",
  ...
  defmodule ListResponse do
    ...
    OpenApiSpex.schema(%{
      ...
      description: "Response schema for multiple Client Sessions",
      type: :object,
      properties: %{
        data: %Schema{
          description: "Client Sessions details",
          type: :array,
