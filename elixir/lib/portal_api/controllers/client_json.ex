defmodule PortalAPI.ClientJSON do
  ...
  defp data(%Device{} = device) do
    %{
      ...
      attested_device_serial: device.attested_device_serial,
      attested_device_uuid: device.attested_device_uuid,
      attested_mdm_device_id: device.attested_mdm_device_id,
