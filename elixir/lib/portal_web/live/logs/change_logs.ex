defmodule PortalWeb.Logs.ChangeLogs do
  ...
  def render(assigns) do
    ...
    <div class="relative flex flex-col h-full overflow-hidden">
      <.page_header>
        ...
        <:description>
          Audit entries recording each insert, update, or delete event in your organization.
        </:description>
        <:action>
      ...
      <.show_panel
        id="change-log-panel"
        open?={not is_nil(@selected_change_log)}
        title={panel_title(@selected_change_log)}
      >
        <.change_log_diff :if={@selected_change_log} change_log={@selected_change_log} />
        <.show_panel_sidebar :if={@selected_change_log}>
          ...
          <.subject_section subject={@selected_change_log.subject} />
        </.show_panel_sidebar>
      </.show_panel>
    </div>
    """
  ...
  defp panel_title(change_log), do: "Change log event #{change_log.event_id}"
