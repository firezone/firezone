defmodule Portal.Google.ErrorHandler do
  @moduledoc """
  Handles Google Workspace directory sync errors.
  ...
  defp action(:internal, message, directory_id) do
    Logger.warning("Internal Google sync error will not change directory state",
