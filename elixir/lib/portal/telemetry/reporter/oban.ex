defmodule Portal.Telemetry.Reporter.Oban do
  ...
  contextual information. For wrapper exceptions like Portal.Entra.SyncError,
  Portal.Google.SyncError,and Portal.Okta.SyncError the original exception/error
  ...
  # Build extra context for Portal.Entra.SyncError
  defp build_extra(
         %Portal.Entra.SyncError{
           reason: reason,
           cause: cause,
  ...
  # Build extra context for Portal.Google.SyncError
  defp build_extra(
         %Portal.Google.SyncError{
           reason: reason,
           cause: cause,
           directory_id: directory_id,
           step: step
  ...
  defp handle_sync_error(
         %Portal.Entra.SyncError{reason: reason},
         %{directory_id: directory_id}
       ) do
  ...
  defp handle_sync_error(
         %Portal.Google.SyncError{reason: reason},
         %{directory_id: directory_id}
       ) do
  ...
  defp handle_sync_error(
         %Portal.Okta.SyncError{reason: reason},
         %{directory_id: directory_id}
       ) do
