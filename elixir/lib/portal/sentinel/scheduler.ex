defmodule Portal.Sentinel.Scheduler do
  @moduledoc """
  Worker to schedule Microsoft Sentinel log sink deliveries.
  """
  use Oban.Worker, queue: :sentinel_scheduler, max_attempts: 1
  alias __MODULE__.Database
  require Logger

  @impl Oban.Worker
  def perform(%Oban.Job{}) do
    Logger.debug("Scheduling Sentinel log sink sync jobs")
