defmodule Portal.Elastic.Scheduler do
  @moduledoc """
  Worker to schedule Elastic log sink deliveries.
  """
  use Oban.Worker, queue: :elastic_scheduler, max_attempts: 1
  alias __MODULE__.Database
  require Logger

  @impl Oban.Worker
  def perform(%Oban.Job{}) do
    Logger.debug("Scheduling Elastic log sink sync jobs")
