defmodule Portal.Config.Definitions do
  ...
  defconfig(:google_ads_customer_id, :string, default: "3339175923")
  ...
  defconfig(:google_ads_registration_conversion_action_id, :string, default: "7754865801")

  @doc "Google Ads import conversion action ID for active Team enrollments."
  defconfig(:google_ads_subscription_conversion_action_id, :string, default: "7754865804")

  @doc "OAuth client ID for the Google Data Manager API."
  defconfig(:google_ads_client_id, :string, default: nil)

  @doc "OAuth client secret for the Google Data Manager API."
  defconfig(:google_ads_client_secret, :string, default: nil)

  @doc "OAuth refresh token authorized for the datamanager scope."
  defconfig(:google_ads_refresh_token, :string, default: nil)
