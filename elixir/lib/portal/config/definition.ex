defmodule Portal.Config.Definition do
  @moduledoc """
  ...
  defmacro __using__(_opts) do
    quote do
      import Portal.Config.Definition
      import Portal.Config, only: [env_var_to_config!: 1]
      ...
      @before_compile Portal.Config.Definition

      @doc "See `Portal.Config.Definition.fetch_doc/2`"
  ...
  defmacro defconfig(key, type, opts \\ []) do
    quote do
      ...
      @spec unquote(key)() :: {Portal.Config.Definition.type(), Portal.Config.Definition.opts()}
