defmodule Portal.Defender.Scheduler do
  use Oban.Worker, queue: :defender_scheduler, max_attempts: 1
  ...
  defmodule Database do
    ...
    def queue_sync_jobs do
      Safe.transact(fn ->
        from(p in Portal.Defender.PostureProvider,
