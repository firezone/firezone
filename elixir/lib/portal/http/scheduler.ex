defmodule Portal.HTTP.Scheduler do
  @moduledoc """
  Worker to schedule HTTP log sink deliveries.
  """
  use Oban.Worker, queue: :http_scheduler, max_attempts: 1
  alias __MODULE__.Database
  require Logger

  @impl Oban.Worker
  def perform(%Oban.Job{}) do
    Logger.debug("Scheduling HTTP log sink sync jobs")
