...
Vagrant.configure('2') do |config|
  ...
  config.vm.define "amazonlinux_2" do |amazonlinux2|
    ...
    amazonlinux2.vm.provision "file", source: "firezone*amazonlinux_2*.rpm", destination: "/tmp/"
  ...
  config.vm.define "centos_7" do |centos7|
    ...
    centos7.vm.provision "file", source: "firezone*centos_7*.rpm", destination: "/tmp/"
  ...
  config.vm.define "centos_8" do |centos8|
    ...
    centos8.vm.provision "file", source: "firezone*centos_8*.rpm", destination: "/tmp/"
  ...
  config.vm.define "debian_10" do |debian10|
    ...
    debian10.vm.provision "file", source: "firezone*debian_10*.rpm", destination: "/tmp/"
  ...
  config.vm.define "fedora_33" do |fedora33|
    ...
    fedora33.vm.provision "file", source: "firezone*fedora_33*.rpm", destination: "/tmp/"
  ...
  config.vm.define "fedora_34" do |fedora34|
    ...
    fedora34.vm.provision "file", source: "firezone*fedora_34*.rpm", destination: "/tmp/"
  ...
  config.vm.define "ubuntu_18.04" do |ubuntu1804|
    ...
    ubuntu1804.vm.provision "file", source: "firezone*ubuntu_18.04*.rpm", destination: "/tmp/"
  ...
  config.vm.define "ubuntu_20.04" do |ubuntu2004|
    ...
    ubuntu2004.vm.provision "file", source: "firezone*ubuntu_20.04*.rpm", destination: "/tmp/"
