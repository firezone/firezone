...
description:
    In December, Firezone organized an off-site in California. Here's what we learned.
authors: [jason]
...
If you want to try it out, our [Docker install script](https://docs.firezone.dev/?utm_source=blog) gets Firezone running in just a few minutes.
:::
