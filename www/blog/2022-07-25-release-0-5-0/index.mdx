...
reference](https://docs.firezone.dev/docs/reference/configuration-file/).
...
docs](https://docs.firezone.dev/deploy/reverse-proxies) for some configuration
...
distros](https://docs.firezone.dev/docs/deploy/supported-platforms/) (or its
...
notes](https://docs.firezone.dev/docs/administer/upgrade/) prior to each
...
section](https://docs.firezone.dev/deploy/install-server/) in the manual
install guide.
...
head to the [deploy guide](https://docs.firezone.dev/deploy) in our docs.

If you're interested in using Firezone in production for your Team or Business,
[contact us](https://docs.firezone.dev/contact/sales) about our Business tier.
