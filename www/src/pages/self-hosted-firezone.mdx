...
<div className="hero">
  <div className="container">
    ...
    <p>
      Deploy now by running the one line install script.
    </p>
  </div>
</div>
...
<hr className="margin-vert--xl" />
 ...
 <center>
   <h2 className="hero__title">Join our community</h2>
         ...
         <p>
            Stay up to date with product launches and new features.
         </p>
   ...
   <div className="row">
     <div className="col col--4">
       <div className="card">
        ...
        <div class="card__footer">
          <center>
           <a className="button button--primary" href="https://github.com/firezone/firezone/graphs/contributors">
           Build Firezone
           </a>
          </center>
        </div>
    ...
    <div className="col col--4">
      <div className="card">
        ...
        <div className="card__footer">
          <center>
           <a className="button button--primary" href="https://github.com/firezone/firezone">
           Github
           </a>
          </center>
        </div>
    ...
    <div className="col col--4">
      <div className="card">
        ...
        <div className="card__footer">
          <center>
           <a className="button button--primary" href="https://firezone-users.slack.com/join/shared_invite/zt-19jd956j4-rWcCqiKMh~ikPGsUFbvZiA#/shared-invite/email">
           Join Slack
           </a>
          </center>
        </div>
 ...
 <center>
   <h2>Firezone closed beta waitlist</h2>
 </center>

 <p>
   Firezone version 1.0 is launching soon. Joing the waitlist to stay up to date with product information and news.
 </p>

   <div className="row margin-top--md">
      <div className="col col--12">
        <center>
       <a className="button button--primary" href="/beta/signup">
