...
<div className="hero">
  <div className="container">
    ...
    <p>Deploy now by running the one line install script below.</p>
  </div>
</div>
...
<p>
  Firezone version 1.0 is launching soon. Joing the waitlist to stay up to date
  with product information and news.
</p>
