...
module "gateways" {
  ...
  observability_log_level = "firezone_gateway=trace,wire=trace,connlib_gateway_shared=trace,webrtc_mdns=error,firezone_tunnel=trace,connlib_shared=trace,warn"
