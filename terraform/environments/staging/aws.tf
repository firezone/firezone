...
module "aws_gateway" {
  ...
  observability_log_level = "phoenix_channel=debug,firezone_gateway=debug,snownet=debug,str0m=info,connlib_gateway_shared=debug,firezone_tunnel=trace,connlib_shared=debug,warn"
