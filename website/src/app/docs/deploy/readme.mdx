...
[configuration file reference](../reference/configuration-file) for details.
...
:::warning Chef Infra Client, the configuration system Chef Omnibus relies on,
has been [scheduled for End-of-Life in 2024](https://docs.chef.io/versions/). As
such, support for Omnibus-based deployments will be removed starting with
Firezone 0.8. To transition to Docker from Omnibus today, follow our
[migration guide ](../administer/migrate). :::
