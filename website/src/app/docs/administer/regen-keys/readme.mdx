...
:::warning Replacing the `DATABASE_ENCRYPTION_KEY` will render all encrypted
...
:::caution Replacing `GUARDIAN_SECRET_KEY`, `SECRET_KEY_BASE`,
...
:::warning Replacing the WireGuard private key will render all existing device
