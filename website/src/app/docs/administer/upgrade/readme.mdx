...
:::info Automatic rollbacks are still under development. We recommend backing up
...
Firezone 0.7.0 introduces a new [REST API](/docs/reference/rest-api/) that
allows administrators to automate much of the day to day configuration of
Firezone.
...
[migrating your installation](/docs/administer/migrate/) to Docker if you
...
[migration guide](/docs/administer/migrate/) to migrate today. In most cases
this can be done in a few minutes using our automatic migration script.

### Update Configuration

Some configuration variables have recently moved to the DB in order to be
configurable at runtime. Check the [configure guide](/docs/deploy/configure/)
