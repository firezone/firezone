...
<Alert color="info">
  ...
  installs, see the [Linux headless Client](/kb/client-apps/linux-client) user
  guide instead.
</Alert>
...
- The Linux GUI Client does not work on ZFS yet [#6704](https://github.com/firezone/firezone/issues/6704)
