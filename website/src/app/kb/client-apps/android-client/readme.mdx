...
1. [Download the Firezone app](https://play.google.com/store/apps/details?id=dev.firezone.android)
   ...
   [download an AAB or APK](https://www.github.com/firezone/firezone/releases)
   from GitHub.
...
If you installed the app from an APK or AAB directly, you will need to download
and install the new APK or AAB manually.
