...
- A Site that contains the Postgres database you want to secure access to.
...
<Alert color="warning">
  For access to high-traffic services like databases, we highly recommend
  setting up multiple Gateways for load balancing. See [Deploying multiple
