...
Learn how to solve a variety of common secure access challenges using Firezone.
...
- [Block malicious DNS](/kb/use-cases/secure-dns): Use Firezone to improve your
  team's Internet security by blocking DNS qeueries to known malicious domains.
- [Scale access to a VPC](/kb/use-cases/scale-vpc-access): Scale access to a
  Google Cloud VPC using multiple Gateways.
- [Route through a public IP](/kb/use-cases/route-traffic-public-ip): Route some
  your team's traffic through a single, static IP address to use services that
  require source traffic to come from specified IP allowlists.
- [Secure access to Postgres](/kb/use-cases/postgres-access): Secure access to
...
- [Access a private network](/kb/use-cases/private-network-access): Access a
  ...
  your firewall.
- [Secure access to a web app](/kb/use-cases/web-app-access): Secure access to a
