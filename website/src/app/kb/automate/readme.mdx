...
<KbCards>
  ...
  <KbCard
    ...
    logo={
    <div>
      <Image width={200} height={200} alt="Docker Compose" src="/images/docker.svg" className="mx-auto mb-8" />
      <FaPlus size={32} className="mx-auto mb-8" />
      <h3 className="text-4xl font-semibold justify-center">Compose</h3>
    </div>
    }>
