...
[Google Cloud Gateway via Regional Instance Group](https://github.com/firezone/firezone/tree/main/terraform/modules/google-cloud/apps/gateway-region-instance-group/).
