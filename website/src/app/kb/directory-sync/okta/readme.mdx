...
This guide will walk you through setting up Firezone Directory Sync for Okta to
automatically synchronize users and groups from your Okta tenant.

## Overview

Firezone Directory Sync for Okta allows you to automatically synchronize users
and groups from your Okta tenant into Firezone. This eliminates the need to
manually create and manage users in Firezone. Users and groups assigned to your
Okta authentication app will be automatically synced.
...
<span class="ml-4">
  Before proceeding with this guide, you must have completed [Okta
  authentication setup](/kb/authenticate/okta) in Firezone.
  <br />
  Directory Sync requires an existing Okta authentication provider to function.
</span>
