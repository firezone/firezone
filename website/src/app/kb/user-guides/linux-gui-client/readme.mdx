...
- If Firezone is signed in, then closed and re-opened, and you cancel unlocking your keyring, Firezone won't start. [#5016](https://github.com/firezone/firezone/issues/5016)
