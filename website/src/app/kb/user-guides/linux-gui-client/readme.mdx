...
The Linux GUI Client is to designed for Linux desktop environments where a
...
- [Download the Linux Client for `x86_64`](/dl/firezone-client-gui-linux/latest/x86_64)
