---
title: "Troubleshoot Common Firezone Issues"
description:
  "Troubleshoot common Firezone issues. Find solutions for connectivity, DNS,
  authentication, and Gateway problems — start here for help."
---
...
**Note:** To troubleshoot the Firezone client apps, see their respective
troubleshooting guides in the [Client App documentation](/kb/client-apps).
