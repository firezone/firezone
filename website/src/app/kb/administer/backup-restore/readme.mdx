...
therefore no backup and restore procedures are generally required. WireGuard
keys are generated ephemerally on-the-fly and don't need to be (nor should be)
saved.
