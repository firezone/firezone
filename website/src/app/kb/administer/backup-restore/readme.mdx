---
title: "Backup & Restore Your Firezone Deployment"
description:
  "Back up and restore your Firezone deployment. Critical config lives in the
  Admin portal — learn what to back up and how to recover."
---

# Backup and Restore

All critical configuration is kept in the Admin portal and therefore no backup
and restore procedures are necessary. WireGuard keys are generated ephemerally
each time a Client or Gateway starts and don't need to be (nor should they be)
saved.
