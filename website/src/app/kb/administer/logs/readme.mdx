---
title: "View & Export Firezone Logs"
description:
  "View Firezone logs for Clients, Gateways, and the Admin portal. Find log
  locations and learn how to export them — see the guide."
---
