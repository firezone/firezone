...
| iOS Client              | N/A                                                                                                                                                                                                                                 |
| Linux Headless Client   | Set by the user via the `LOG_DIR` environment variable, otherwise STDOUT                                                                                                                                                            |
| Windows Headless Client | Set by the user via the `LOG_DIR` environment variable, otherwise STDOUT                                                                                                                                                            |
