---
title: "Firezone Documentation: Setup & Guides"
titleAbsolute: true
description:
  "Learn how to deploy, configure, and scale Firezone. Step-by-step guides for
  clients, gateways, identity providers, and zero trust policies."
---
...
- [Architecture](/kb/architecture): Start here if you're new to Firezone and
...
- [Client apps](/kb/client-apps): Documentation for installing and using the
