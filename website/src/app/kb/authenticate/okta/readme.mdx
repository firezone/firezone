...
Firezone integrates with [Okta](https://www.okta.com/) using a custom connector
that supports both authentication and directory sync. Use this guide if you're
looking to setup SSO with Okta for your Firezone account and optionally sync
