...
<Alert
  color="info"
  html={`
    The Google Workspace connector will be tied to the administrator account who
...
user/group sync. The user will be **signed out of all clients** and forced to
reauthenticate.
...
<Alert
  ...
  html={`
    ...
    deletes users. Admins must manually delete users in the admin portal in
    order to fully remove them from the system.
  `}
/>
