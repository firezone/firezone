...
Next, you'll create a service account to use for the directory sync. Using a
service account ensures the sync process is decoupled from your admin user
account and can continue to operate unobstructed even if you or another admin
