...
organization can authenticate to Firezone using this connector after the first
directory sync is completed, and directory sync will occur every few minutes.
