...
## How Firezone treats deleted or suspended users

Firezone <strong>never</strong> deletes synced users or groups. This helps to
preserve audit trails and other logged activity within Firezone.

Instead, when a user is deleted or suspended in your identity provider, Firezone
...
Similarly, Firezone does not delete synced groups or organizational units.

Instead, when a group or organizational unit is deleted in your identity
provider, Firezone will hide the group and delete any associated policies.
