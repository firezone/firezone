...
[Microsoft Entra](/kb/authenticate/entra), [Okta](/kb/authenticate/okta) or
[JumpCloud](/kb/authenticate/jumpcloud) connectors. No further configuration is
necessary. Once the connector is activated, users, groups, and organizational
