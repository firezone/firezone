...
It's possible to create multiple providers for the Google, Entra, Okta, and OIDC
connectors. This allows you to authenticate users against multiple providers at
the same time, each with different Groups and Policies applied to them.
...
## Configuring authenticationAuthentication context
