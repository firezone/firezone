...
1. [Microsoft Entra](/kb/authenticate/google): Supports authentication and user
...
<Alert
  ...
  html={`
    ...
    that all other identity providers become unusable. We recommend keeping at least
    one admin enabled for the email provider for account recovery.
  `}
/>
