...
- [https://www.firezone.dev/kb/authenticate/jumpcloud/jumpcloud-oauth-screen-logo.png](https://www.firezone.dev/kb/authenticate/jumpcloud/jumpcloud-oauth-screen-logo.png)
...
section of the **Details** pane and follow the prompts from there.
