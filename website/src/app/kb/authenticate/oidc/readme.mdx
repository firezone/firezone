...
<Alert color="info">
  Due to the limitations of the OIDC specification, user / group sync is **not
  supported** with the universal OIDC connector. For user / group sync for
  Google Workspace, Microsoft Entra, and Okta, see
</Alert>
