...
<!-- TODO: Uncomment when we have more data on Gateway sizing
...
For examples on how to deploy multiple Gateways using Terraform, see our example
[Terraform modules](https://github.com/firezone/firezone/tree/main/terraform/examples).
