...
Similar to automatic failover above, two or more gateways deployed within a site
will automatic load balance client connections to resources in that site.
