...
| ----------------------- | ------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `FIREZONE_TOKEN`        |               | Token generated by the portal to authorize the Gateway's connection. Can also be passed using a [systemd credential](https://systemd.io/CREDENTIALS) named `FIREZONE_TOKEN`.                                    |
