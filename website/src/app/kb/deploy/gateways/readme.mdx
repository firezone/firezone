...
| `FIREZONE_ID`         |               | Unique identifier for this Gateway. Must be unique across all Gateways in your account. We recommend using a machine identifier for this such as the contents of `/etc/machine-id` or similar.                                                                                                       |
