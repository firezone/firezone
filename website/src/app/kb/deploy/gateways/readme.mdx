...
| N/A                          | {/* Update this when Relay regions change */} See [relay-ips.json](/relay-ips.json) | `3478`        | STUN            | STUN protocol signaling                                         |
| N/A                          | {/* Update this when Relay regions change */} See [relay-ips.json](/relay-ips.json) | `49152-65535` | TURN            | TURN protocol channel data                                      |
