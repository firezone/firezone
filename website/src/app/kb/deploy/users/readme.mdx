...
After creating a user, you can choose to assign the user to one or more groups. This will
ultimately determine the policies that apply to the user, so it's important to
ensure that the groups have the correct policies defined. We'll cover creating policies
in the next section.
