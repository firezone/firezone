...
| `keepAppRunning`          | `Boolean` | `false`                            | Whether to install a LaunchAgent that keeps the macOS app running and relaunches it if macOS closes it. This also enables `startOnLogin` while set.                                                                                                                                                                                                                  | macOS                        | 1.5.15          |
