...
On Apple, Android, and Linux devices, these are applied _in addition_ to any
locally-configured search domains. On Windows devices, however, these are
applied _instead of_ any locally-configured search domains. If this is causing
an issue for your use case, leave feedback on
