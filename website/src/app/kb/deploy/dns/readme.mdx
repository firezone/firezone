...
provides Split DNS and fallback resolver configuration for each client
application in your Firezone account. Read more below to understand how it works
...
Upstream DNS in the Clients can be configured with the servers of your choosing
