---
title: "Set Up Split DNS for Firezone"
description:
  "Configure Firezone split DNS to resolve internal hostnames over your private
  network. Set up DNS resources — follow the configuration guide."
---
...
Introduced in macOS 1.5.10, iOS 1.5.10, Android 1.5.7, Windows GUI 1.5.9,
Windows Headless 1.5.9, and Linux Headless 1.5.9
