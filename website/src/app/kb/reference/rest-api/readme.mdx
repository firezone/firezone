...
can download the spec at [https://api.firezone.dev/openapi](https://api.firezone.dev/openapi) or view the spec with a Swagger UI web interface at [https://api.firezone.dev/swaggerui](https://api.firezone.dev/swaggerui).
