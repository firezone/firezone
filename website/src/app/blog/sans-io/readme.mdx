...
`quinn` makes use of it in its [`quinn-proto`](https://github.com/quinn-rs/quinn/tree/main/quinn-proto) crate.
There is also [`str0m`](https://github.com/algesten/str0m), a sans-IO WebRTC implementation.
...
Before we dive into sans-IO itself, let's focus your attention on a few of Rust's features:
...
<Image
    ...
    src="https://www.planttext.com/api/plantuml/svg/SoWkIImgAStDuOhMYbNGrRLJ24xDAx42aIaAHQc5fQd59LnS8345e5nGQd9gPbbgYXMC1LHIN92VLvpAXP0Apa_EJYrnJ4afueABWaq6si3b03GNQ1i0"
...
How do Rust’s features that we discussed above fit into this?
...
This post covered a lot of ground, let's quickly recap:

- TODO

<!--

Notes: Discuss how hole-punching only works if we send from the same socket so we need multi-plexing.
