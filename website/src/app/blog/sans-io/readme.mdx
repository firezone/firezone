...
You can find both these snippets as functional programs in the following repository: https://firezone/sans-io-blog-example.
...
TODO: Lead over to state machines and eventloops.
