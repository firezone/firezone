...
description: "Learn how Firezone uses the sans-IO pattern to build testable, deterministic Rust networking code. A deep dive into our connlib design."
postTitle: "sans-IO: The secret to effective Rust for network services"
authorName: "Thomas Eizinger"
authorTitle: "Distributed Systems Engineer"
authorEmail: thomas@firezone.dev
date: "July 2, 2024"
---
