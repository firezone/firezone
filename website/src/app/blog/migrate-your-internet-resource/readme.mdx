...
This also means you'll need to deploy dedicated Gateway(s) to the Internet Site to handle traffic for the Internet Resource. This ensures
internet-bound traffic is properly isolated from other Resources in your account.
