...
a group, not just the direct ones. This means fewer overall groups are needed to
define your access controls, and fewer overall policies you need to manage.
