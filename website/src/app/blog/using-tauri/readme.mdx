...
description: "Read why Firezone chose Tauri to build native Linux and Windows clients. A look at our cross-platform desktop app architecture and tradeoffs."
postTitle: "Using Tauri to build a cross-platform security app"
