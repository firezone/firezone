...
single firewall configuration and still enjoy the same level of performance as if
...
[Google Workspace](https://workspace.google.com/), with more providers on the way.
