...
that Firezone 1.0 is now generally available, and we're thrilled for for you to
try it. [Sign up](https://app.firezone.dev/sign_up) now to get started.
...
This process is completely transparent to the user and happens in most cases within a few
seconds.
