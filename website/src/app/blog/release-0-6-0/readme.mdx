...
postTitle: "Firezone 0.6.0 Released!"
...
We've written an [in-depth migration guide](/docs/administer/migrate) to migrate
your instance from Omnibus to Docker:
