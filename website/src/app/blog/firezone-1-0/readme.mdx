...
While WireGuard itself is a marvelous feat of engineering, it intentionally
lacks tooling that would make it usable in typical remote access scenarios. It
provides only the basic building blocks; you still have plan your routing,
generate keys, and tie these to user identities if you were hoping to use
WireGuard to replace your existing VPN.

Doing all of this was an error-prone inconvenience myself and colleagues had
faced often in our day jobs. We agreed that someone should build a tool to make
this easier. I had recently quit my job at Cisco and had a bit of extra time on
my hands, so I decided this was the perfect opportunity to brush up on some new
tech I'd been hoping to learn (namely: Elixir/Phoenix/LiveView). So I got to
building.
...
There are now over 3,000 Firezone instances running in wild (that we know
about!) securing private networks for hobbyists, schools, non-profits, and
