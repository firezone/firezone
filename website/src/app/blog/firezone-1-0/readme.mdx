...
couldn't easily know who you were talking to, you couldn't always trust them not
to misbehave.
...
After the firewall authenticates the outside entity, they agree to package up
the information packets between each other so that the Internet routers in
...
packet with more network attributes that allow the Internet routers in between
to forward them properly. Thus giving this technology its name: Virtual Private
Network.
...
would be a perimeter breach. Not good.
...
updates. We're introducing a slew of new features in 1.0 in addition to the new
architecture described in this post, so follow along there if you're curious how
things are going or you have comments. Feedback welcome!
