---
title: "DNS Resource Reliability Improvements"
description: "Client and Gateway 1.1 ships a more reliable DNS routing system that fixes long-tail resolution issues for production deployments."
postTitle: "Improving reliability for DNS Resources"
