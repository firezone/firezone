...
service on the Resource not allowed by the restriction, the Gateway will simply
drop the traffic, preventing it from ever reaching the Resource in question.
