...
problem: it turns out humans aren't great at remembering long strings of numbers. To solve this, 
a simple system was
...
responsibility of resolving a fully-qualified domain name (FQDN) to a series
