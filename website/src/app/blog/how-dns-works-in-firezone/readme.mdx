---
title: "DNS Internals in Firezone Clients"
description: "Why Firezone's approach to DNS resolution is different — split DNS, search domains, and how Clients resolve internal hostnames."
postTitle: "How DNS Works in Firezone"
