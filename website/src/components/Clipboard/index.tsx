...
const clipboardTheme: ClipboardWithIconTheme = {
  base: "absolute end-3 top-4 inline-flex cursor-pointer items-center justify-center rounded-sm p-2 text-neutral-500 transition transform duration-200 hover:text-neutral-800 hover:bg-neutral-50",
  icon: {
    defaultIcon: "h-4 w-4",
