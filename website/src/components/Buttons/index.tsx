...
export function RequestDemoButton() {
  return (
    <Link href="/contact/sales">
      <button
        type="button"
        className="text-xs px-3 py-1.5 md:text-sm md:px-5 md:py-2.5 text-white bg-primary-450 font-semibold hover:font-bold tracking-tight rounded duration-0 hover:scale-105 transition transform"
      >
        Request demo
      </button>
    </Link>
