...
const navbarThemeLight = createTheme({
  navbar: {
    root: {
...
const navbarThemeDark = createTheme({
  navbar: {
    root: {
...
const dropdownThemeLight = createTheme({
  dropdown: {
...
const dropdownThemeDark = createTheme({
  dropdown: {
    arrowIcon: "ml-2 h-4 w-4",
    content: "py-1 focus:outline-none",
    floating: {
...
function applyTheme(
  theme: typeof navbarThemeLight | typeof navbarThemeDark,
      ...
      <Navbar fluid>
        ...
        <NavbarBrand as={Link} href="/">
          <Image
            ...
            src={
              light
                ? "/images/logo-main-light.svg"
                : "/images/logo-main-dark.svg"
            }
        ...
        <NavbarCollapse>
          <ThemeProvider theme={light ? dropdownThemeLight : dropdownThemeDark}>
