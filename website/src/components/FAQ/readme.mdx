...
information. Accounts on the Team plan are billed when they start service, or at
the beginning of each billing cycle. Enterprise plans are billed annually. Team
and Enterprise plans can be paid via credit card, ACH, or wire transfer.
Firezone does not require a credit card to get started.
