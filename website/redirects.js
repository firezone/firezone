...
module.exports = [
   ...
   */
  {
    ...
    destination:
      ...
      "https://www.github.com/firezone/firezone/releases/download/gateway-2.0.0/firezone-gateway_2.0.0_x86_64",
    permanent: false,
  },
  {
    ...
    destination:
      // mark:current-gateway-version
      "https://www.github.com/firezone/firezone/releases/download/gateway-2.0.0/firezone-gateway_2.0.0_aarch64",
    permanent: false,
  },
  {
    ...
    destination:
      // mark:current-gateway-version
      "https://www.github.com/firezone/firezone/releases/download/gateway-2.0.0/firezone-gateway_2.0.0_armv7",
    permanent: false,
  },
  /*
