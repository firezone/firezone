...
module.exports = [
   ...
   */
  {
    ...
    destination:
      ...
      "https://www.github.com/firezone/firezone/releases/download/macos-client-1.5.1/firezone-macos-client-1.5.1.dmg",
    permanent: false,
  },
  {
    ...
    destination:
      // mark:current-apple-version
      "https://www.github.com/firezone/firezone/releases/download/macos-client-1.5.1/firezone-macos-client-1.5.1.pkg",
    permanent: false,
  },
  /*
   *
   ...
   */
  {
    ...
    destination:
      ...
      "https://www.github.com/firezone/firezone/releases/download/android-client-1.5.0/firezone-android-client-1.5.0.apk",
    permanent: false,
  },
  /*
   *
   ...
   */
  {
    ...
    destination:
      ...
      "https://www.github.com/firezone/firezone/releases/download/gui-client-1.4.14/firezone-client-gui-windows_1.4.14_x86_64.msi",
    permanent: false,
  },
  /*
   *
   ...
   */
  {
    ...
    destination:
      ...
      "https://www.github.com/firezone/firezone/releases/download/headless-client-1.4.8/firezone-client-headless-windows_1.4.8_x86_64.exe",
    permanent: false,
  },
  /*
   *
   ...
   */
  {
    ...
    destination:
      // mark:current-gui-version
      "https://www.github.com/firezone/firezone/releases/download/gui-client-1.4.14/firezone-client-gui-linux_1.4.14_x86_64.deb",
    permanent: false,
  },
  {
    ...
    destination:
      // mark:current-gui-version
      "https://www.github.com/firezone/firezone/releases/download/gui-client-1.4.14/firezone-client-gui-linux_1.4.14_aarch64.deb",
    permanent: false,
  },
  {
    ...
    destination:
      // mark:current-headless-version
      "https://www.github.com/firezone/firezone/releases/download/headless-client-1.4.8/firezone-client-headless-linux_1.4.8_x86_64",
    permanent: false,
  },
  {
    ...
    destination:
      // mark:current-headless-version
      "https://www.github.com/firezone/firezone/releases/download/headless-client-1.4.8/firezone-client-headless-linux_1.4.8_aarch64",
    permanent: false,
  },
  {
    ...
    destination:
      // mark:current-headless-version
      "https://www.github.com/firezone/firezone/releases/download/headless-client-1.4.8/firezone-client-headless-linux_1.4.8_armv7",
    permanent: false,
  },
  /*
   *
