...
module.exports = [
   ...
   */
  {
    ...
    destination:
      ...
      "https://www.github.com/firezone/firezone/releases/download/android-client-1.4.8/firezone-android-client-1.4.8.apk",
    permanent: false,
  },
  /*
   *
   ...
   */
  {
    ...
    destination:
      ...
      "https://www.github.com/firezone/firezone/releases/download/gui-client-1.4.12/firezone-client-gui-windows_1.4.12_x86_64.msi",
    permanent: false,
  },
  /*
   *
   ...
   */
  {
    ...
    destination:
      ...
      "https://www.github.com/firezone/firezone/releases/download/headless-client-1.4.7/firezone-client-headless-windows_1.4.7_x86_64.exe",
    permanent: false,
  },
  /*
   *
   ...
   */
  {
    ...
    destination:
      // mark:current-gui-version
      "https://www.github.com/firezone/firezone/releases/download/gui-client-1.4.12/firezone-client-gui-linux_1.4.12_x86_64.deb",
    permanent: false,
  },
  {
    ...
    destination:
      // mark:current-gui-version
      "https://www.github.com/firezone/firezone/releases/download/gui-client-1.4.12/firezone-client-gui-linux_1.4.12_aarch64.deb",
    permanent: false,
  },
  {
    ...
    destination:
      // mark:current-headless-version
      "https://www.github.com/firezone/firezone/releases/download/headless-client-1.4.7/firezone-client-headless-linux_1.4.7_x86_64",
    permanent: false,
  },
  {
    ...
    destination:
      // mark:current-headless-version
      "https://www.github.com/firezone/firezone/releases/download/headless-client-1.4.7/firezone-client-headless-linux_1.4.7_aarch64",
    permanent: false,
  },
  {
    ...
    destination:
      // mark:current-headless-version
      "https://www.github.com/firezone/firezone/releases/download/headless-client-1.4.7/firezone-client-headless-linux_1.4.7_armv7",
    permanent: false,
  },
  /*
   *
   ...
   */
  {
    ...
    destination:
      ...
      "https://www.github.com/firezone/firezone/releases/download/gateway-1.4.6/firezone-gateway_1.4.6_x86_64",
    permanent: false,
  },
  {
    ...
    destination:
      // mark:current-gateway-version
      "https://www.github.com/firezone/firezone/releases/download/gateway-1.4.6/firezone-gateway_1.4.6_aarch64",
    permanent: false,
  },
  {
    ...
    destination:
      // mark:current-gateway-version
      "https://www.github.com/firezone/firezone/releases/download/gateway-1.4.6/firezone-gateway_1.4.6_armv7",
    permanent: false,
  },
  /*
