...
OPEN_SOCKETS=$(sudo docker exec firezone-relay-1 ss --tcp --numeric state established dport 8081 | tail --lines=+2) # Portal listens on port 8081, list all open connections
