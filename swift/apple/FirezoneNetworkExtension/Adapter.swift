...
public class Adapter {
  ...
  // Docs on filter strings: https://docs.rs/tracing-subscriber/latest/tracing_subscriber/filter/struct.EnvFilter.html
    ...
    private let logFilterString =
      "connlib_client_apple=debug,firezone_tunnel=trace,libs_common=debug,firezone_client_connlib=debug,warn"
  #else
    private let logFilterString =
      "connlib_client_apple=info,firezone_tunnel=info,libs_common=info,firezone_client_connlib=info,warn"
  #endif
