...
#include <stdbool.h>
typedef struct DisconnectError DisconnectError;
void __swift_bridge__$DisconnectError$_free(void* self);

void* __swift_bridge__$Vec_DisconnectError$new(void);
void __swift_bridge__$Vec_DisconnectError$drop(void* vec_ptr);
void __swift_bridge__$Vec_DisconnectError$push(void* vec_ptr, void* item_ptr);
void* __swift_bridge__$Vec_DisconnectError$pop(void* vec_ptr);
void* __swift_bridge__$Vec_DisconnectError$get(void* vec_ptr, uintptr_t index);
void* __swift_bridge__$Vec_DisconnectError$get_mut(void* vec_ptr, uintptr_t index);
uintptr_t __swift_bridge__$Vec_DisconnectError$len(void* vec_ptr);
void* __swift_bridge__$Vec_DisconnectError$as_ptr(void* vec_ptr);
...
bool __swift_bridge__$DisconnectError$is_authentication_error(void* self);
void* __swift_bridge__$DisconnectError$to_string(void* self);
