...
public final class VPNConfigurationManager {
  ...
  init(manager: any TunnelProviderManager) async throws {
    ...
    protocolConfiguration.providerBundleIdentifier = BundleHelper.networkExtensionBundleIdentifier
  ...
  // Delegates to the free function in LegacyConfiguration.swift for shared access.
  nonisolated public static func legacyConfiguration(
    ...
    -> [String: String]?
  {
    FirezoneShared.legacyConfiguration(protocolConfiguration: protocolConfiguration)
  }
