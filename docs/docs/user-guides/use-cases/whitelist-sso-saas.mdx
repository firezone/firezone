---
title: Restrict App SSO to VPN Users
sidebar_position: 4
---

Some identity providers support restricting SSO functionality
to a pre-defined network zone (IP range). Configure this to the IP of
your Firezone egress gateway, so SSO is restricted to users
