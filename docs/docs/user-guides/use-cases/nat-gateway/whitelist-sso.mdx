---
title: Restrict SSO to VPN Users
sidebar_position: 1
...
to a pre-defined network zone (IP range). You can set this to the IP of
your Firezone gateway, so authentication is restricted to users
...
enabled, you may be locked out Okta entirely when your VPN session
expires.
:::
