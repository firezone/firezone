...
sidebar_position: 4
description:
    Set up your client app to connect to your organizations private
...
### Automatically enable the VPN (on-demand)

:::note
Requires admin access.
:::

On-demand can be set to automatically enable the VPN under certain
network conditions.

On the Android and iOS mobile apps you can automatically
enable the VPN on Wi-fi and/or Cellular networks.

On the MacOS and Windows desktop apps you can automatically
enable the VPN on Wi-fi networks and/or Ethernet connections.
