...
Dockerized Firezone currently supports the following platforms:

| Platform | Runtime | Status |
| --- | --- | --- |
| `linux/amd64`, `linux/arm64` | Docker Server | Fully-supported |
| `linux/arm64`, `linux/amd64` | Docker Desktop | Fully-supported |
|
