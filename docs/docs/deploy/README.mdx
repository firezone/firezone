...
Firezone can typically be deployed on most Linux servers in minutes. Read more
below to get started.

## Deployment Methods

You have three options for deploying and managing Firezone:

1. [Docker](./docker) (recommended)
1. [Omnibus](./omnibus)
1. [Build from source](./from-source) (**unsupported** only for advanced users)
