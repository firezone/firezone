...
From your terminal, run these steps to build from the checked out source:
...
Now all you need are the database and reverse proxy that you've hopefully setup.
