...
:::note
This guide assumes you have complete the prerequisite steps
...
and fill out the following on the subsequent setup pages:
...
contains additional details on the purpose of configuration settings. In all
