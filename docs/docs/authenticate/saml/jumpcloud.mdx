...
| SP Entity ID | This should be the same as your Firezone `SAML_ENTITY_ID`, default `urn:firezone.dev:firezone-app`. |
...
Now, downlad the IdP Metadata document by selecting the App you just created
