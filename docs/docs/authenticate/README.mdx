...
[contact us](https://www.firezone.dev/contact/sales?utm_source=docs) about custom integrations.
:::
...
](https://www.firezone.dev/slack?utm_source=docs) for community support or
[contact us for paid, hands-on support
](https://www.firezone.dev/contact/sales?utm_source=docs).
