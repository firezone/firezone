...
`EXTERNAL_URL + /auth/oidc/<provider_key>/callback/`
...
Enter a JSON containing the config settings below into the
single sign-on section of the page. Once complete,
...
If applied correctly, you will see an option to sign
in with Auth0 in your Firezone portal.
