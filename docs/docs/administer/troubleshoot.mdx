...
you can recreate your admin user.
...
<TabItem value="docker" label="Docker">
  ...
  `ADMIN_EMAIL` 
    ...
    **Note**: If local authentication is disabled, resetting the admin user's password will not 
    re-enable it.
...
If issues arise with your identity provider integration, it's possible you could be locked out of the admin portal. To re-enable local authentication so you can log in and resolve the issue, run the following query on the host of your Firezone instance:
